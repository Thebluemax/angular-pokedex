 ...
 * @fileoverview Screen for the main menu of the Pokédex application, providing navigation options to various categories such as items, regions, pokemons, berries, and abilities.
 * @since 2025-06-22
 * 
 * @description
 * Screen for the main menu of the Pokédex application, providing navigation options to various categories such as items, regions, pokemons, berries, and abilities.
